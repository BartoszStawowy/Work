...
#przyciski
nastepny = Button(okno, text = 'Add bug', fg = 'black',padx = 30, pady = 10, command = dodawaniebuga)
export = Button(okno, text = 'Export to xls', fg = 'black',padx = 30, pady = 10, command = exportxlc)
...
nastepny.grid(row = 6, column = 1,padx = 30, pady = 10)#, padx = 40, pady = 10)
export.grid(row = 6, column = 2,padx = 30, pady = 10)
